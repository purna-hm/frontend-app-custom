...
export const metadata: Metadata = { title: "Ph.D. - Submission" };
export default function Page() {
  return (
    <>
      <PageHeader title="Ph.D. Submission" subtitle="Download the official document below." breadcrumbs={[{ label: "Home", href: "/" }, { label: "PhD", href: "/phd" }, { label: "Submission" }]} />
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 text-center">
          <FileText size={48} className="text-[#1a1a5e] mx-auto mb-4" />
          <h2 className="text-xl font-black text-[#1a1a5e] mb-2">Ph.D. Submission</h2>
